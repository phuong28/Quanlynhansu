    ...
    <div class="card-content">
                        ...
                        <tr>
                            ...
                            <td class="actions-cell">
                                <div class="buttons right nowrap">
                                    <a  href="{{route('delete.user',$item->id)}} "class="button small green --jb-modal" data-target="sample-modal-2"
                                        type="button">
                                        @method('DELETE')
                                        <span class="icon">Xóa</span>
                                    </a>
                                    <a  href="{{route('user.edit',$item->id)}}" class="button small red --jb-modal" data-target="sample-modal"
                                        type="button">
                            ...
                            <td class="actions-cell">
                                <div class="buttons right nowrap">
                                    <a  href="{{route('user.follow',$item->id)}}" class="button small blue --jb-modal" data-target="sample-modal"
                                        type="button">
        ...
        <div class="table-pagination">
            <div class="flex items-center justify-between">
                <div class="buttons">
                    <button type="button" class="button active">{{$users->links()}}</button>
                </div>
            </div>
        </div>
    </div>
