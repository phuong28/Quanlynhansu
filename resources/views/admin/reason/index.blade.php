                        ...
                        <tr>
                            ...
                            <td class="actions-cell">
                                <div class="buttons right nowrap">
                                    <a href="{{route('admin.delete.reason',$item->id)}}"class="button small green --jb-modal" data-target="sample-modal-2"
                                        type="button">
                                        @method('DELETE')
                                        <span class="icon">Xóa</span>
                                    </a>
                                    <a href="{{route('admin.edit.reason',$item->id)}}" class="button small red --jb-modal" data-target="sample-modal"
                                        type="button">
